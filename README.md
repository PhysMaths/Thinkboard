...
A full-stack MERN application for creating, storing, and managing notes
--- built with **MongoDB, Express, React, Node.js**, and enhanced with
**Upstash Redis rate-limiting**, **Axios API layer**, **TailwindCSS**,
and **Vite**.
